...
vsnl_mon_db = pymysql.connect(host='192.168.34.185', port=3306 ,user='dbchefusr', passwd='dbchefusr185', db='DBmonitor_VSNL')
cursor_mon_vsnl = vsnl_mon_db.cursor()
all_mon_ip_sql = "select ip_address from dbinfra where (service_type='MariaDB' or service_type='MySQL') and is_alive='Yes' and " \
      "is_production='Yes' and is_monitor='Yes' and service_alert ='Yes'"
